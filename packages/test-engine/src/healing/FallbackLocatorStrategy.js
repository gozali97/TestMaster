...
exports.FallbackLocatorStrategy = void 0;
/**
 ...
 */
class FallbackLocatorStrategy {
    objectRepository;
    name = 'FALLBACK';
    priority = 1; // Highest priority
    constructor(objectRepository = new Map()) {
     ...
     */
    async generateFallbackLocators(failedLocator, page) {
...
exports.FallbackLocatorStrategy = FallbackLocatorStrategy;
//# sourceMappingURL=FallbackLocatorStrategy.js.map